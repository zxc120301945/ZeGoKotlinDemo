...
public class PreferenceUtil {
    ...
    private PreferenceUtil() {
        mSharedPreferences = KotlinZegoApplication.Companion.getApp().getSharedPreferences(SHARE_PREFERENCE_NAME, AppCompatActivity.MODE_PRIVATE);
    }
    ...
    public void setAppKey(byte[] signKey) {
        String strSignKey = ZegoAppUtil.convertSignKey2String(signKey);
    ...
    public byte[] getAppKey() {
        ...
        try {
            return ZegoAppUtil.parseSignKeyFromString(strSignKey);
